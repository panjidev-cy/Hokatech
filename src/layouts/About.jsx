...
const About = () => {
    return(
        <>
            ...
            <section
            className="w-full min-h-screen flex items-center justify-between md:mt-32 md:mb-12 pt-16 md:pt-24"
            id="about"
            >
                ...
                <div className="w-1/2 lg:w-full md:min-h-screen">
                    <h4 className="bg-dark text-yellow-300 inline-block px-3 font-afacad font-bold uppercase shadow-md shadow-slate-300 rounded-md">
                    he?
                    </h4>
                    ...
                    I am Panji Bhekti, ready to help you build stunning, high-performance apps. Discover my work and be a part of this
                    story.
                    </p>
                    <div className="pt-4">
                        <h1 className="text-2xl font-bold mb-4 font-poppins bg-dark text-yellow-300 inline-block px-2 py-1 rounded-md">
                            Skills
                        </h1>
