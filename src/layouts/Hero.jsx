...
const Hero = () => {
    ...
    return (
        <>
            <header className=" bg-white w-full h-screen flex items-center justify-between md:items-center md:justify-center px-4    md:min-h-screen " id="home">
                    <div className="w-1/2 md:w-full hide">
                        ...
                        <p className="text-base font-poppins mt-12 w-[80%] sm:w-[90%] border-l-2 pl-4 md:text-sm">
